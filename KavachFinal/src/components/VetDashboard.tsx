              ...
              {vlmQueue.map((item) => (
                <div key={item.id} className="p-3 bg-[#F7F5F0] rounded-lg hover:shadow-sm transition-shadow">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" className="flex-1 bg-[#4CAF7D] hover:bg-[#3D9B68] text-white text-xs">
                      Accept
                    </Button>
                    <Button size="sm" variant="outline" className="flex-1 border-[#C0392B] text-[#C0392B] hover:bg-[#C0392B] hover:text-white text-xs">
                      Correct
                    </Button>
                  </div>
                </div>
